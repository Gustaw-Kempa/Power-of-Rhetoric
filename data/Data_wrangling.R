...
cases_data <- read_csv('datasets/cases/global_confirmed_cases.csv')
...
UK_speeches  <-
  read_delim("datasets/speeches/UK.csv")
...
UK_res <-
  tibble(
    sentiment = read.csv("datasets/emotions/UK/sent_temp.csv")[, 2],
    happiness = read.csv('datasets/emotions/UK/hap_temp.csv')[, 2],
    persuasion = read.csv('datasets/emotions/UK/pers_temp.csv')[, 2],
    anger = read.csv('datasets/emotions/UK/ang_temp.csv')[, 2],
    fear = read.csv('datasets/emotions/UK/fear_temp.csv')[, 2],
    surprise = read.csv('datasets/emotions/UK/surp_temp.csv')[, 2],
    informativeness = read.csv('datasets/emotions/UK/inf_temp.csv')[, 2]
...
UK_polls <- read_csv('datasets/polls/UK_polls.csv')
UK_polls <-
  UK_polls %>% group_by(week) %>% summarise(support = mean(approve_johnson))
...
USA_speeches  <-
  read_delim("datasets/speeches/USA.tsv")
#fixing the dates in dataset
...
# binding the results
USA_res <- read_csv("datasets/emotions/USA/USA_emotions.csv")
...
USA_polls <- read_csv('datasets/polls/USA_polls.csv')
USA_polls <-
  USA_polls %>% group_by(week) %>% summarise(support = mean(approve))
...
ES_speeches  <-
  read_delim("datasets/speeches/speeches_ES_translated")
#fixing the dates in dataset
...
# binding the results
ES_res <- read_csv("datasets/emotions/ES/ES_emotions.csv")
...
ES_polls <- read_csv('datasets/polls/ES_polls.csv')
ES_polls <-
...
FR_speeches  <-
  data <- read_delim("datasets/speeches/france.csv")
#fixing the dates in dataset
...
# binding the results
FR_res <- read_csv("datasets/emotions/FR/FR_emotions.csv")
...
FR_polls <- read_csv('datasets/polls/FR_polls.csv')
FR_polls <-
...
# binding the results
DE_res <- read_csv("datasets/emotions/DE/DE_emotions.csv")
...
DE_polls <- read_csv('datasets/polls/DE_polls.csv')
DE_polls <-
...
# binding the results
IT_res <- read_csv("datasets/emotions/IT/IT_emotions.csv")
...
IT_polls <- read_csv('datasets/polls/IT_polls.csv')
IT_polls <-
...
write_csv(model_data, "datasets/model_data.csv")
